# 🤖 ИИ-ассистент системного аналитика

Методология, безопасность и промпт-шаблоны для работы с LLM в энтерпрайзе.  
Материалы с митапа [Название/Дата]. Всё на синтетических данных.
...
Указывайте автора при использовании. Производные работы — под той же лицензией.
